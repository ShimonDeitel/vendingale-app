...
struct ContentView: View {
    @EnvironmentObject var store: VendingaleStore
    @EnvironmentObject var purchases: PurchaseManager

    @State private var showingAdd = false
    @State private var showingSettings = false
    @State private var showingPaywall = false
    @State private var editingEntry: VendingaleEntry?
    ...
    private func entryRow(_ entry: VendingaleEntry) -> some View {
        HStack {
...
struct AddEntrySheet: View {
    ...
    init(existing: VendingaleEntry? = nil, onSave: @escaping (String, Double) -> Void) {
